...
import bcrypt
from taskmanagerapi.modules.auth.services.dtos.oauth2_google_dto import GoogleUserInfo
from taskmanagerapi.modules.auth.services.dtos.sign_up_dto import SignUpInputDTO
