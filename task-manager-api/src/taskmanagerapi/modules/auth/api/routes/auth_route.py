...
from taskmanagerapi.modules.auth.api.dependencies.auth_dependency import (
    get_auth_services,
)
from taskmanagerapi.modules.auth.api.schemas.auth_google_schema import (
    AuthGoogleResponseSchema,
    AuthGoolgleRequestSchema,
)
from taskmanagerapi.modules.auth.api.schemas.sign_in_schema import (
    SignInRequestSchema,
    SignInResponseSchema,
)
from taskmanagerapi.modules.auth.api.schemas.sign_up_schema import (
    SignUpRequestSchema,
    SignUpResponseSchema,
)
from taskmanagerapi.modules.auth.services.auth_service import AuthService
