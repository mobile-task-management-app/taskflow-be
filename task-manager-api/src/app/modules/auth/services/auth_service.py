...
from app.modules.auth.services.dtos.oauth2_google_dto import GoogleOauth2OutputDTO
from app.modules.auth.services.dtos.sign_in_dto import SignInInputDTO, SignInOutputDTO
from app.modules.auth.services.dtos.sign_up_dto import (
    SignUpInputDTO,
    SignUpOutputDTO,
)
...
from app.modules.users.db.models.user import User
from app.modules.users.db.models.user_create import UserCreate
from app.modules.users.db.models.user_update import UserUpdate
